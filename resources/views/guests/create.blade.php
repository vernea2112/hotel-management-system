...
@section('title', __('messages.add_new') . ' ' . __('messages.guests'))
...
<div class="page-header">
    ...
    <h1><i class="bi bi-person-plus"></i> {{ __('messages.add_new') }} {{ __('messages.guests') }}</h1>
</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('document_type') is-invalid @enderror" id="document_type" name="document_type" required>
                                ...
                                <option value="driver_license" {{ old('document_type') == 'driver_license' ? 'selected' : '' }}>Driver License</option>
                            </select>
